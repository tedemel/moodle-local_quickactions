...
class execute extends external_api {
    ...
    public static function execute(int $courseid, string $actionid, array $cmids, string $paramsjson): array {
        ...
        $result = $cls::execute($actionparams, $cmidsint, $courseid, $context);
    ...
    public static function execute_returns(): external_single_structure {
        return new external_single_structure([
            ...
            'failed' => new external_value(PARAM_INT, 'Items failed'),
            'undoid' => new external_value(PARAM_INT, 'Undo record id (0 if no undo available)'),
        ]);
    }
}
